...
// 5. Store your favourite colour and print a sentence using it.
...
// 8. Convert the string "25" into a number.
const strNumber  = "25";
...
const inputA = Number(prompt("Enter first number:"));
const inputB = Number(prompt("Enter second number:"));
...
const numToSquare = Number(prompt("Enter a number:"));
console.log("Square:", numToSquare ** 2);


// 16. Determine whether a number is positive or negative.
const checkNum =  Number(prompt("enter number to check:"));
switch (true) {
  case checkNum > 0:
